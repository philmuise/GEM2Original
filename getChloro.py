...
acquisition day for a dark targets feature class exists.
...
class getChloro(object):
    ...
    def execute(self, parameters, messages):
        ...
        # Connect to ftp host
        arcpy.AddMessage("\nConnecting to host ftp site: " + fileHostPath)
        ...
        for gdb in gdbList:
            ...
            for fc in fcList:
                ...
                dateFolder = self.yearDay(fc.split('_')[1])
                chloroFilePath = fileDir + dateFolder
    ...
    def yearDay(self, fc_dateString):
        """Calculate the day of the year for each RADARSAT-2 acquisition (to conform to MODIS naming convention)
        ...
        return year + '/' + str(yDay).rjust(3, '0')
